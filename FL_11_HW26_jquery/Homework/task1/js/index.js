...
$('#title').css({'text-align' : 'center', 'top-margin' : '0'});

// div after header: add double border and padding 20px
$('header + div').css({'border-width' : '10px','border-color' : 'purple', 'border-style' : 'double', 'padding' : '20px'});
...
// in #list-1
  ...
  $('#list-1 li:hidden').not('.cloned').css({'display' : 'block'});
  // hide empty li
...
// ******************************************************
// [name],
// [name|='value'],a value either equal to a given string or starting with that string followed by a hyphen (-).
// [name*='value'],a value containing a given substring.
// [name~='value'],a value containing separate word
// [name$='value'],ending with
// [name^='value']starting with
...
$('img').parent('div').css({'float' : 'left', 'border' : 'red'});
